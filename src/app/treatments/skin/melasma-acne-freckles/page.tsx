                  ...
                  <div className="w-full h-64 bg-gradient-to-br from-gray-200 to-gray-300 rounded-xl overflow-hidden shadow-lg">
                    <div className="w-full h-full bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center">
                      <div className="text-center text-gray-600">
                        ...
                        <p className="text-sm text-gray-500">Professional Melasma Acne Freckles Treatment</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-10 sm:px-8 lg:px-32">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              See the transformative results of our advanced skin treatment technology
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-10 sm:px-8 lg:px-32">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience the transformative benefits of our advanced skin treatment technology
            </p>
          </motion.div>

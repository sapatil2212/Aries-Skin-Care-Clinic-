...
export default function EarlobeRepairPermanentPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* What is Earlobe Repair Section */}
      <section className="py-5 md:py-5 bg-white">
        <div className="container mx-auto px-4 sm:px-8 lg:px-32 pt-4 pb-4 md:pt-8 md:pb-2 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-8 items-center">
            ...
            >
              ...
              >
                <img 
                  src={HeroImage2.src}
                  alt="Earlobe Repair Treatment Process" 
                  className="w-full h-[300px] md:h-[500px] object-contain"
                />
              </motion.div>
            </motion.div>
          ...
          <motion.div
            ...
            >
              ...
              >
                Advanced <span className="text-primary">Surgical Repair</span> Procedure
              </motion.h2>
              ...
              >
                <p>
                  Earlobe repair is a safe and effective surgical procedure designed to restore torn, stretched, or damaged earlobes to their natural shape and appearance. This cosmetic surgery can repair various types of earlobe damage caused by heavy earrings, trauma, or stretching.
                </p>
                <p>
                  Our experienced surgeons use precise techniques to reconstruct the earlobe, ensuring minimal scarring and optimal aesthetic results. The procedure is performed under local anesthesia and typically takes less than an hour to complete.
                </p>
              </motion.div>
            </motion.div>
          </div>
          ...
          >
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Key Benefits of Earlobe Repair
                ...
                Experience the transformative benefits of our advanced surgical repair procedure
              </p>
          </motion.div>

          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
            {earlobeRepairBenefits.map((benefit, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="p-3 md:p-6 h-full bg-gradient-to-br from-blue-50 to-green-50 border-0 rounded-lg transition-all duration-300 group">
                  ...
                  <p className="text-gray-600 text-xs md:text-sm">
                    Achieve natural-looking earlobes with our proven surgical approach
                  </p>
                </div>
              </motion.div>
            ))}
            ...
            >
              ...
              >
                  ...
                  <div className="w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    ...
                    <p className="text-xs md:text-md text-gray-600">Evaluation of earlobe damage and surgical planning</p>
                    </div>
                  </div>
                  ...
                  <div className="w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    ...
                    <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Anesthesia Administration</h3>
                    <p className="text-xs md:text-md text-gray-600">Local anesthesia for comfortable procedure</p>
                    </div>
                  </div>
                  ...
                  <div className="w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    ...
                    <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Surgical Repair</h3>
                    <p className="text-xs md:text-md text-gray-600">Precise surgical reconstruction of the earlobe</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Suturing & Dressing</h3>
                    <p className="text-xs md:text-md text-gray-600">Careful suturing and protective dressing application</p>
                  </div>
                </div>
              ...
              {[
                {
                  ...
                  description: "Surgical repair for completely torn earlobes"
                },
                {
                  title: "Stretched Earlobe Repair",
                  description: "Reconstruction for stretched or elongated earlobes"
                },
                {
                  title: "Split Earlobe Repair",
                  description: "Repair for partially split or damaged earlobes"
                }
              ].map((item, index) => (
                <motion.div
                  key={index}
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-8 items-center">
            ...
            >
              ...
              <motion.h2
                ...
                className="text-xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight"
              >
                Perfect For <span className="text-primary">Earlobe Repair</span>
              </motion.h2>
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-sm md:text-md text-gray-700">Torn or split earlobes</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Stretched or elongated earlobes</span>
                    </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Earlobe damage from trauma</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Heavy earring damage</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">General earlobe reconstruction needs</span>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-sm md:text-md text-gray-700">Active infections in the ear area</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <X className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Severe bleeding disorders</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <X className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
            ...
            >
              ...
              >
                <img 
                  src={HeroImage4.src}
                  alt="Earlobe Repair for Everyone" 
                  className="w-full h-[300px] md:h-[500px] object-contain"
                />
              </motion.div>
            </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
              {[
                ...
                {
                  title: "Gentle Care",
                  description: "Keep the area clean and avoid pressure"
                },
                {
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-xs md:text-md text-gray-600 max-w-3xl mx-auto">
                At Aries Skin & General Clinic, we provide safe, effective, and professional earlobe repair treatments under the guidance of skilled doctors and trained professionals. We ensure optimal results with proper aftercare guidance.
              </p>
            </div>
              ...
              {[
                {
                  icon: Award,
                  title: "Expert Care",
                  description: "Expert surgical care with modern equipment"
                },
                {
                  icon: Users,
            ...
            >
              <p className="text-xs sm:text-lg font-medium text-gray-800">
                ✨ Your journey to natural-looking earlobes starts at Aries Skin & General Clinic.
              </p>
            </motion.div>
          </motion.div>
        </div>

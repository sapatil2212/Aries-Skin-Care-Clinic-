...
export default function GeneralTreatmentsPage() {
  const generalTreatments = TREATMENTS.filter(treatment => treatment.category === 'general')
  const categoryInfo = TREATMENT_CATEGORIES.find(cat => cat.id === 'general')
    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary via-white to-secondary">
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-32 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {generalTreatments.map((treatment) => (

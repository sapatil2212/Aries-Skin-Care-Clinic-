            ...
            >
              ...
              >
                  ...
                  <div className="w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    ...
                    <p className="text-xs md:text-md text-gray-600">Comprehensive medical history and symptom assessment</p>
                    </div>
                  </div>
                  ...
                  <div className="w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    ...
                    <p className="text-xs md:text-md text-gray-600">Thorough gynecological examination and assessment</p>
                    </div>
                  </div>
                  ...
                  <div className="w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    ...
                    <p className="text-xs md:text-md text-gray-600">Laboratory tests and imaging as needed</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs md:text-md text-gray-600">Personalized treatment plan based on diagnosis</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs md:text-md text-gray-600">Ongoing monitoring and preventive care guidance</p>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-8 items-center">
            ...
            >
              ...
              <motion.h2
                ...
                className="text-xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight"
              >
                Perfect For <span className="text-primary">Women's Health</span>
              </motion.h2>
              ...
              <motion.div
                ...
                className="space-y-3"
              >
                <h3 className="text-md sm:text-lg font-semibold text-gray-900">This treatment is suitable for women with:</h3>
                <div className="space-y-2">
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Routine health check-ups</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Menstrual irregularities</span>
                    </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Reproductive health concerns</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Infection symptoms</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Preventive care needs</span>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-sm md:text-md text-gray-700">Men (gynecological care is for women only)</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Emergency medical conditions</span>
                  </div>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              >
                <img 
                  src={HeroImage4.src}
                  alt="Gynecological Care for Everyone" 
                  className="w-full h-[300px] md:h-[500px] object-contain"
                />
              </motion.div>
            </motion.div>
              ...
              {[
                {
                  ...
                  description: "Minimal discomfort with proper care instructions"
                },
                {
                  title: "Follow-up Care",
                  description: "Regular check-ups to monitor progress"
                },
                {
                  title: "Lifestyle Guidance",
                  description: "Personalized advice for optimal health"
                }
              ].map((item, index) => (
                <motion.div
                  key={index}

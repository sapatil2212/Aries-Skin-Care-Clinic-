...
export default function GeneralGynecologicalCareandTreatmentPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-orange-100/50 via-orange-50/30 to-red-100/50 py-20 lg:py-32">
                  ...
                  <div className="w-full h-64 bg-gradient-to-br from-gray-200 to-gray-300 rounded-xl overflow-hidden shadow-lg">
                    <div className="w-full h-full bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center">
                      <div className="text-center text-gray-600">
                        ...
                        <p className="text-sm text-gray-500">Professional Gynecological Care Treatment</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-10 sm:px-8 lg:px-32">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              See the transformative results of our advanced general treatment technology
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-10 sm:px-8 lg:px-32">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience the transformative benefits of our advanced general treatment technology
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {treatment.benefits.map((benefit, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="p-6 h-full bg-gradient-to-br from-orange-50 to-red-50 border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
        ...
        <div className="container mx-auto px-10 sm:px-8 lg:px-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <Card className="p-8 bg-gradient-to-br from-orange-50 to-red-50 border-0 shadow-xl">
                <div className="text-center space-y-4">
        ...
        <div className="container mx-auto px-10 sm:px-8 lg:px-32 text-center">
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-bold">
              Ready to Transform Your General?
            </h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-10 sm:px-8 lg:px-32">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            >
              ← Back to General Care & Treatments
            </Link>

...
import HeroImage1 from "../../../../../public/treatments/General/1.png"
import HeroImage2 from "../../../../../public/treatments/General/2.png"
...
const treatment = TREATMENTS.find(t => t.id === 'gynecological-care');

export default function GeneralGynecologicalCareandTreatmentPage() {
  ...
  // Gynecological Care specific benefits
  const gynecologicalCareBenefits = [
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 sm:px-8 lg:px-32 pt-4 pb-4 md:pt-8 md:pb-2 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-8 items-center">
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-sm text-gray-600">Comprehensive women's health care</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm text-gray-600">Expert gynecological consultation</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm text-gray-600">Safe and confidential treatment</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm text-gray-600">Modern diagnostic facilities</span>
                  </div>
              </div>
              </motion.div>
            ...
            >
              <img 
                  src={HeroImage1.src}
                alt="Gynecological Care Treatment" 
      ...
      {/* What is Gynecological Care Section */}
      <section className="py-5 md:py-5 bg-white">
        <div className="container mx-auto px-4 sm:px-8 lg:px-32 pt-4 pb-4 md:pt-8 md:pb-2 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-8 items-center">
            ...
            >
              ...
              >
                <img 
                  src={HeroImage2.src}
                  alt="Gynecological Care Treatment Process" 
                  className="w-full h-[300px] md:h-[500px] object-contain"
                />
              </motion.div>
            </motion.div>
          ...
          <motion.div
            ...
            >
              ...
              >
                Comprehensive <span className="text-primary">Women's Health</span> Care
              </motion.h2>
              ...
              >
                <p>
                  Gynecological care encompasses comprehensive medical services focused on women's reproductive health and overall well-being. Our expert gynecologists provide specialized care for various conditions affecting the female reproductive system.
                </p>
                <p>
                  We offer a full range of gynecological services including routine check-ups, diagnostic procedures, treatment of infections, menstrual disorders, and preventive care. Our approach combines medical expertise with compassionate care in a comfortable, confidential environment.
                </p>
              </motion.div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-8 lg:px-32 pt-4 pb-4 md:pt-8 md:pb-2 relative z-10">
          ...
          >
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Key Benefits of Gynecological Care
            </h2>
                         <p className="text-xs md:text-[15px] text-gray-600 max-w-3xl mx-5 md:mx-auto">
                Experience comprehensive women's health care with our expert gynecological services
              </p>
          </motion.div>

          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
            {gynecologicalCareBenefits.map((benefit, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="p-3 md:p-6 h-full bg-gradient-to-br from-blue-50 to-green-50 border-0 rounded-lg transition-all duration-300 group">
                  ...
                  <p className="text-gray-600 text-xs md:text-sm">
                    Achieve optimal women's health with our comprehensive care approach
                  </p>
                </div>
              </motion.div>
            ))}
              ...
              {[
                {
                  ...
                  description: "Regular gynecological examinations and screenings"
                },
                {
                  title: "Infection Treatment",
                  description: "Treatment of various gynecological infections"
                },
                {
                  title: "Menstrual Disorders",
                  description: "Management of irregular periods and related issues"
                }
              ].map((item, index) => (
                <motion.div
                  key={index}
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-xs md:text-md text-gray-600 max-w-3xl mx-auto">
                At Aries Skin & General Clinic, we provide comprehensive gynecological care under the guidance of skilled doctors and trained professionals. We ensure optimal women's health with proper care and guidance.
              </p>
            </div>
              ...
              {[
                {
                  icon: Award,
                  title: "Expert Care",
                  description: "Expert gynecological care with modern facilities"
                },
                {
                  icon: Users,
                  title: "Safe Treatment",
                  description: "Safe, confidential treatments in comfortable environment"
                },
                {
                  icon: Shield,
                ...
                },
                {
                  ...
                  description: "Proven results with satisfied patients"
                }
              ].map((item, index) => (
                <motion.div
                  key={index}
            ...
            >
              <p className="text-xs sm:text-lg font-medium text-gray-800">
                ✨ Your journey to optimal women's health starts at Aries Skin & General Clinic.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-8 lg:px-32 pt-4 pb-4 md:pt-8 md:pb-2 relative z-10">
          ...
          >
            ...
            <p className="text-xs md:text-md text-gray-600 mx-5">
              Join thousands of satisfied patients who have achieved optimal women's health with us
            </p>

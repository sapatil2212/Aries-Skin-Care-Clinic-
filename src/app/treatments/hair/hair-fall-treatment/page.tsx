...
const treatment = TREATMENTS.find(t => t.id === 'hair-fall-treatment');
...
export default function HairFallTreatmentPage() {
  ...
  // Hair Fall Treatment specific benefits
  const hairFallTreatmentBenefits = [
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-sm text-gray-600">Reducing hair fall and breakage</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm text-gray-600">Strengthening hair follicles</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-teal-600 mt-0.5 flex-shrink-0" />
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm text-gray-600">Promoting healthy hair growth</span>
                  </div>
              </div>
              </motion.div>
      ...
      {/* What is Hair Fall Treatment Section */}
      <section className="py-5 md:py-5 bg-white">
        <div className="container mx-auto px-4 sm:px-8 lg:px-32 pt-4 pb-4 md:pt-8 md:pb-2 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-8 items-center">
            ...
            >
              ...
              >
                <img 
                  src={HeroImage2.src}
                  alt="Hair Fall Treatment Process" 
                  className="w-full h-[300px] md:h-[500px] object-contain"
                />
              </motion.div>
            </motion.div>
          ...
          <motion.div
            ...
            >
              ...
              >
                Advanced <span className="text-primary">Hair Restoration</span> Therapy
              </motion.h2>
              ...
              >
                <p>
                  Hair fall treatment is a comprehensive therapy designed to address the root causes of hair loss and promote healthy hair growth. This treatment combines advanced techniques with proven solutions to strengthen hair follicles and reduce hair fall.
                </p>
                <p>
                  Our treatment involves scalp analysis, targeted therapy application, and personalized care to address various causes of hair fall including hormonal imbalances, nutritional deficiencies, stress, and genetic factors.
                </p>
              </motion.div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-8 lg:px-32 pt-4 pb-4 md:pt-8 md:pb-2 relative z-10">
          ...
          >
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Key Benefits of Hair Fall Treatment
            </h2>
                         <p className="text-xs md:text-[15px] text-gray-600 max-w-3xl mx-5 md:mx-auto">
                Experience the transformative benefits of our advanced hair restoration therapy
              </p>
          </motion.div>

          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
            {hairFallTreatmentBenefits.map((benefit, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="p-3 md:p-6 h-full bg-gradient-to-br from-blue-50 to-green-50 border-0 rounded-lg transition-all duration-300 group">
                  ...
                  <p className="text-gray-600 text-xs md:text-sm">
                    Achieve stronger, healthier hair with our proven treatment approach
                  </p>
                </div>
              </motion.div>
            ))}
            ...
            >
              ...
              >
                  ...
                  <div className="w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Hair & Scalp Analysis</h3>
                    <p className="text-xs md:text-md text-gray-600">Comprehensive examination to identify hair fall causes</p>
                    </div>
                  </div>
                  ...
                  <div className="w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    ...
                    <p className="text-xs md:text-md text-gray-600">Deep cleansing and preparation of the scalp</p>
                    </div>
                  </div>
                  ...
                  <div className="w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    ...
                    <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Treatment Application</h3>
                    <p className="text-xs md:text-md text-gray-600">Application of specialized hair fall treatment solutions</p>
                  </div>
                </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
              {[
                {
                  title: "Scalp Therapy",
                  description: "Deep scalp treatment to strengthen hair follicles"
                },
                {
                  title: "Hair Growth Stimulation",
                  description: "Advanced therapy to promote new hair growth"
                },
                {
                  title: "Nutritional Support",
                  description: "Hair-friendly nutrients to improve hair health"
                }
              ].map((item, index) => (
                <motion.div
                  key={index}
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-8 items-center">
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-sm md:text-md text-gray-700">Excessive hair fall and thinning</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Weak and brittle hair</span>
                    </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Hormonal hair loss</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Stress-related hair fall</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-teal-600 mt-0.5 flex-shrink-0" />
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-sm md:text-md text-gray-700">Complete baldness (advanced stages)</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <X className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                    <span className="text-sm md:text-md text-gray-700">Severe scalp infections or wounds</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <X className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
            ...
            >
              ...
              >
                <img 
                  src={HeroImage4.src}
                  alt="Hair Fall Treatment for Everyone" 
                  className="w-full h-[300px] md:h-[500px] object-contain"
                />
              </motion.div>
            </motion.div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
              {[
                ...
                },
                {
                  ...
                  description: "Regular sessions for maintaining healthy hair growth"
                }
              ].map((item, index) => (
                <motion.div
                  key={index}
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-xs md:text-md text-gray-600 max-w-3xl mx-auto">
                At Aries Skin & General Clinic, we provide safe, effective, and professional hair fall treatments under the guidance of skilled doctors and trained professionals. We ensure optimal results with proper aftercare guidance.
              </p>
            </div>
              ...
              {[
                {
                  icon: Award,
                  title: "Expert Care",
                  description: "Expert hair treatment care with modern equipment"
                },
                {
                  icon: Users,
            ...
            >
              <p className="text-xs sm:text-lg font-medium text-gray-800">
                ✨ Your journey to healthy, strong hair starts at Aries Skin & General Clinic.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-8 lg:px-32 pt-4 pb-4 md:pt-8 md:pb-2 relative z-10">
          ...
          >
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold text-gray-900">
              Ready to Stop Hair Fall?
            </h2>
            <p className="text-xs md:text-md text-gray-600 mx-5">
              Join thousands of satisfied patients who have achieved healthy, strong hair with us
            </p>

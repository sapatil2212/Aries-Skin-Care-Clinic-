  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-32 right-8 z-50 bg-blue-500 hover:bg-blue-600 text-white p-3 rounded-full shadow-xl transition-all duration-300 hover:scale-110 group"
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
      >
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="fixed bottom-8 left-8 z-50 bg-primary hover:bg-primary-dark text-white p-3 rounded-full shadow-xl transition-all duration-300 hover:scale-110 group"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
          >
